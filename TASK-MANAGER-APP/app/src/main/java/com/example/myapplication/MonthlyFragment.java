...
public class MonthlyFragment extends Fragment {
    ...
    RadioGroup rg;
    String type;
    String TAG = MonthlyFragment.class.getName();
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        getTasks();
        fragmentView = inflater.inflate(R.layout.fragment_monthly, container, false);
        fab = fragmentView.findViewById(R.id.fab2);
    ...
    private void setAdapterTaskList() {
        recyclerView = fragmentView.findViewById(R.id.recyclerView2);
                ...
                if (!response.isSuccessful()) {
                    ...
                    if (response.body() != null) {
                        for (int i = 0; i < response.body().data.size(); i++) {
                            if(taskModel.data.get(i).getType().equals("2")){
